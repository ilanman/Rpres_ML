...
```{r new_point_knn, echo=FALSE,fig.height=5,fig.width=5,fig.align='left'}
...
```{r caret_conf,comment="",message=FALSE}
...
```{r roc_plot, comment="",echo=FALSE,fig.height=5,fig.width=5}
...
ggplot(data=df,aes(x=X,y=Y))+geom_point()+geom_point(data=new_preds,aes(x=X,y=Y,color='red'),size=3.5)+scale_colour_discrete(guide = FALSE)
```
...
```{r multi_plot,fig.height=5,fig.width=5,echo=FALSE,message=FALSE}
library(gridExtra)
x <- seq(0,1,by=0.005)
